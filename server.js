...
function init() {
	inquirer.prompt(questions.options).then((data) => {
		option(data);
	});
}
...
function option(data) {
	switch (data.options) {
		...
		case "Update an employee role":
			inquirer.prompt(questions.updateEmployeeRole).then((data) => {
				console.log(data);
				updateEmployee(data);
			});
			break;
		...
		case "Delete department":
			inquirer.prompt(questions.deleteDepartment).then((data) => {
				deleteDepartment(data);
			});
			break;
		// Delete role
		case "Delete role":
			inquirer.prompt(questions.deleteRole).then((data) => {
				deleteRole(data);
			});
			break;
		// Delete employee
		case "Delete employee":
			inquirer.prompt(questions.deleteEmployee).then((data) => {
				deleteEmployee(data);
			});
			break;
		// Quit program
